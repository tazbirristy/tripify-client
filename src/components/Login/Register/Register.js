        ...
        <div className="lg:w-1/2">
          <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mt-10">
            ...
            >
              ...
              <button className="block w-full p-3 text-center rounded-sm dark:text-gray-200 bg-indigo-600 hover:bg-indigo-500">
                Register
              </button>
            </form>
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 32 32"
                  className="w-7 h-7 fill-current text-gray-200 hover:text-indigo-400"
                >
