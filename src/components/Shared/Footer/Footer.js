...
const Footer = () => {
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 bg-purple-900">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex">
            ...
            <a
              ...
              className="transition-colors duration-300 text-white hover:text-deep-purple-800"
            >
              312, Nikunja Street, Mirpur, Dhaka
            </a>
          </div>
        </div>
        <div>
          ...
          <div className="flex items-center mt-1 space-x-3">
            ...
            <a href="/" className="text-white hover:bg-black">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="h-5 hover:bg-black"
              >
      ...
      <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p className="text-sm text-white">
          © Copyright 2022 Tripify. All rights reserved.
        </p>
      </div>
    </div>
  );
