    ...
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-12">
      <div className="my-10 grid lg:col-span-6">
        <div className="max-w-full p-4 shadow-md dark:bg-gray-900 dark:text-gray-100 rounded-md">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-semibold dark:text-purple-300">
                {serviceName}
              </h3>

              <p className="leading-snug dark:text-gray-300 text-justify">
                {description}
              </p>
            </div>
          </div>
      ...
      <div className="my-10 grid lg:col-span-6">
        <div className="mx-auto">
          {!user?.uid ? (
            <>
              <Link
                to="/login"
                className="text-xl font-semibold bg-gray-500 rounded-sm px-4 py-2 text-gray-100"
              >
                Login
              </Link>
            </>
        ...
        {user?.uid ? (
          <div>
            ...
            <form onSubmit={handleReview} className="w-2/3 mx-auto">
              <input
                ...
                className="w-full border px-3 py-3 rounded-md border-purple-500 outline-purple-800"
                required
                readOnly
              />
              <input
          ...
          <>
            <h1 className="text-center font-bold text-purple-700 text-3xl">
